...
export default function Detail() {
    ...
    function sendMail() {
        MailComposer.composeAsync({
            subject: 'Herói do Caso: Cachoro atropelado',
            recipients: ['douglasddd@gmail.com'],
            body: message,
        })
    }

    function sendWhatsApp() {
        Linking.openURL(`whatsapp://send?phone=555198470879&text=${message}`);
    }
            ...
            <View style={styles.incident}>
                ...
                <Text style={styles.incidentValue}>
                    {Intl.NumberFormat('pt-BR', {
                        style: 'currency',
                        currency: 'BRL'}).format(incident.value).replace(/^(\D+)/, '$1 ')
                    }
                </Text>
            </View>
